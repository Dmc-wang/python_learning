...
if __name__ == "__main__":
    organizer = FileOrganizer("~/Downloads","~/Downloads/test")
    organizer.organize_by_category(dry_run = True)

    print("\n" + "=" * 50)
    print("再次运行正式模式（如需）:")

print("organizer.organize_by_category(dry_run=False)")